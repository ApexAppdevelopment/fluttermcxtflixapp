...
class _AllTrendingWidgetState extends State<AllTrendingWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllTrendingModel());
