                    ...
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image: Image.network(
                                          columnWatchHistoryRecord.moviebanner!,
                                        ).image,
                                      ),
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      columnWatchHistoryRecord.movietitle!,
                                    ...
                                    Spacer(),
                                    Text(
                                      '${columnWatchHistoryRecord.startTime} / ${columnWatchHistoryRecord.endTime}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText1
                                          .override(
                                            fontFamily:
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 0.0),
                                      child: Text(
                                        'Last watched: ${dateTimeFormat(
                                          'relative',
                                          columnWatchHistoryRecord.watchon,
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: LinearPercentIndicator(
                                          percent: columnWatchHistoryRecord
                                              .watchmins!
                                              .toDouble(),
                                          width: 134.0,
                                          lineHeight: 4.0,
                          ...
                          Lottie.network(
                            'https://assets4.lottiefiles.com/packages/lf20_krlvwyxz.json',
                            width: 60.0,
                            height: 60.0,
                            fit: BoxFit.cover,
                            animate: true,
