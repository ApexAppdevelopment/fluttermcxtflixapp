...
/// Functions to query MainmovieRecords (as a Stream and as a Future).
Future<int> queryMainmovieRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MainmovieRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MainmovieRecord>> queryMainmovieRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<MainmovieRecord>> queryMainmovieRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<MainmovieRecord>> queryMainmovieRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query WatchHistoryRecords (as a Stream and as a Future).
Future<int> queryWatchHistoryRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<WatchHistoryRecord>> queryWatchHistoryRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<WatchHistoryRecord>> queryWatchHistoryRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<WatchHistoryRecord>> queryWatchHistoryRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
